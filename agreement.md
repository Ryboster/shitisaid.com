...
<li>
In the event of emergency, relevant person is required to inform the rest of the team, and where feasible, provide estimated date/time of resolution. Verifiable evidence containing personal and/or sensitive data must <b>NOT</b> be shared with the team (GDPR breach).
</li>
...
<li>
Significant mistakes leading to obstruction or delay of the product's delivery will be forgiven but remembered. <b>Repeated</b> mistakes (e.g. team leader sleeping in) may lead to violation.
</li>
...
<li>
Those who do not sign this document must not be given edit access to any of the project's proprietary files.
</li>

<li>
All developers are required to complete at least a single ticket per project sprint.
</li>
